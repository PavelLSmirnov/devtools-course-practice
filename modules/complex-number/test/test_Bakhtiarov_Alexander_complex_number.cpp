...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Multiply_ComplexNumbers) {
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Divide_ComplexNumbers) {
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Check_Equality) {
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Add) {
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Subtract) {
    ComplexNumber z1(1, 2);
    ComplexNumber z2(3, 4);
    ComplexNumber z3 = z1 - z2;
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Compare) {
    ComplexNumber z1(1, 2);
    ComplexNumber z2(3, 4);
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Change) {
    ComplexNumber z1(1, 2);
    z1.setRe(3);
    z1.setIm(4);
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Create_Copy) {
    ComplexNumber z1(1, 2);
    ComplexNumber z2(z1);
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, Create_Default) {
    ComplexNumber z1;
...
TEST(Bakhtiarov_Alexander_ComplexNumberTest, DivisionOperatorWithFractions) {
